...
export const TaskComponent = ({ id, task, isChecked }: TaskComponentProps) => {
  ...
  return (
    <article
      className="shadow-shape flex cursor-default items-start gap-3 rounded-lg bg-gray-500 p-4 transition-all hover:brightness-110 outline-none focus:border-purple-dark focus:ring-2 placeholder:select-none focus:ring-purple-dark"
      tabIndex={0}
    ...
    >
      ...
      />
      <p
        className={`${checkboxCheckedClassName} flex-1 text-sm text-gray-100 outline-none focus:border-purple-dark focus:ring-2 placeholder:select-none focus:ring-purple-dark transition-all duration-150 rounded-md`}
        tabIndex={0}
      >
        {task}
      </p>
